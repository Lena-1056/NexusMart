...
SMTP_PORT = 465
SMTP_USER = "Enter your SMTP email address here"  # Use environment variable for security
SMTP_PASS = os.environ.get("SMTP_PASSWORD", "Enter your SMTP password here")  # Use environment variable for security
